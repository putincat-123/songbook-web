...
function dressFront(svg, stage) {
  ...
  if (stage === 'teen') {
    insertLayer(svg, 'pixel-clothes', `
      <path d="M34 61h28v4h3v30h-34V65h3z" fill="#88a9d4"/>
      <rect x="38" y="64" width="20" height="5" fill="#b8ccec"/>
      <rect x="35" y="91" width="26" height="4" fill="#6f8fc1"/>
      <path d="M37 62h5v7h4v7h4v7h4v7h6v5h-7v-4h-4v-7h-4v-7h-4v-7h-4z" fill="#795a8d"/>`);
    insertLayer(svg, 'pixel-accessory', `
      <rect x="59" y="88" width="11" height="12" rx="2" fill="#67483d"/>
      <rect x="61" y="90" width="7" height="8" fill="#b786a8"/>
      <rect x="63" y="92" width="3" height="2" fill="#f2bd4e"/>`);
  }

  if (stage === 'adult') {
    insertLayer(svg, 'pixel-clothes', `
      <path d="M34 61h10v4h8v-4h10v4h4v32H30V65h4z" fill="#59617f"/>
      <path d="M38 65h7v4h6v-4h7v5h3v23H35V70h3z" fill="#737c9f"/>
      <rect x="35" y="93" width="26" height="4" fill="#4c536f"/>
      <rect x="46" y="71" width="5" height="5" fill="#d8b65a"/>`);
    insertLayer(svg, 'pixel-accessory', `
...
function backOutfit(stage) {
  ...
  if (stage === 'teen') {
    return `<g id="back-outfit">
      ...
      <rect x="38" y="64" width="20" height="5" fill="#b8ccec"/>
      <rect x="35" y="91" width="26" height="4" fill="#6f8fc1"/>
      <path d="M59 62h-5v7h-4v7h-4v7h-4v7h-6v5h7v-4h4v-7h4v-7h4v-7h4z" fill="#795a8d"/>
      <rect x="27" y="88" width="11" height="12" rx="2" fill="#67483d"/>
      <rect x="29" y="90" width="7" height="8" fill="#b786a8"/>
    </g>`;
  }
  ...
  return `<g id="back-outfit">
    ...
    <path d="M38 65h7v4h6v-4h7v5h3v23H35V70h3z" fill="#737c9f"/>
    <rect x="35" y="93" width="26" height="4" fill="#4c536f"/>
    <rect x="42" y="67" width="12" height="3" fill="#4c536f"/>
  </g>`;
}

function sharedBackArms() {
  return `<g id="back-arms">
    <g id="arm-left">
      <path d="M28 66h7v5h2v14h-2v6h-4v4h-7v-2h-4v-5h-2V75h2v-5h3v-4z" fill="#67483d"/>
      <path d="M29 69h4v4h2v11h-2v5h-3v3h-5v-2h-3v-4h-1V76h2v-4h2v-3z" fill="#f0bc79"/>
      <path d="M22 87h7v2h3v4h-2v3h-7v-2h-3v-4h2z" fill="#fff0d2"/>
    </g>
    <g id="arm-right">
      <path d="M61 66h7v4h3v5h2v13h-2v5h-4v3h-7v-4h-3v-7h-2V70h2v-4z" fill="#67483d"/>
      <path d="M62 69h4v3h2v4h2v10h-2v4h-3v3h-4v-3h-2v-6h-1V72h2v-3z" fill="#f0bc79"/>
      <path d="M63 87h7v2h2v4h-2v3h-7v-2h-2v-4h2z" fill="#fff0d2"/>
    </g>
  </g>`;
}
