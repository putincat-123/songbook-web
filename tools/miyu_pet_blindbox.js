(() => {
  ...
  style.textContent = `
    ...
    .px-blind-mask{position:absolute;left:41%;top:62%;z-index:3;width:92px;height:88px;background:linear-gradient(#d8c3a5 0 30%,#d8c3a5 30% 100%);pointer-events:none}
